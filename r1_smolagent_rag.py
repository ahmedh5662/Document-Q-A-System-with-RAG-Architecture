...
This script sets up and configures the models and tools used by the R1 conversational agent.
It loads environment variables, initializes models from Hugging Face or OpenAI, and sets up
the reasoning model for better Retrieval-Augmented Generation (RAG).

Functions:
- get_model: Retrieves and initializes a model based on the provided model ID and configuration.

Modules:
- smolagents: Provides various agent models and tools.
- dotenv: Loads environment variables from a .env file.
- langchain_chroma: Provides Chroma integration for LangChain.
